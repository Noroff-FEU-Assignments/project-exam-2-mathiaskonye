...
export default function ContactForm() {
    ...
    const schema = yup.object().shape({
        title: yup.string().required("Please enter a title. Minimum 3 characters.").min(3, "Minimum 3 characters."),
        firstName: yup.string().required("Please enter your first name. Minimum 3 characters.").min(3, "Minimum 3 characters."),
        lastName: yup.string().required("Please enter your last name. Minimum 3 characters.").min(3, "Minimum 4 characters."),
    ...
    return (
      ...
      <Col xs={12} sm={12} md={12} lg={6} xl={6} className="p-0">
          <div className="contact-image">
              <h1 className="p-3 contact-text">CONTACT US</h1>
          </div>
      </Col>
      </Row>
      </Container>
